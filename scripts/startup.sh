...
alias nanorst2='cd ~/barc/arduino/.arduino_nano328_node_tractionC; cp ../arduino_nano328_node_tractionC/arduino_nano328_node_tractionC.ino src/; ano clean; ano build -m nano328; ano upload -m nano328 -p /dev/ttyUSB0; roscd barc'
